        ...
        _createClass(e, [
            {
                ...
                value: function () {
                    var t = document.querySelector("html"),
                        e = document.querySelector("#toggle-theme"),
                        n = null == e ? void 0 : e.querySelector("i");
                    null != e &&
                        e.addEventListener("click", function () {
                            "dark" == t.getAttribute("class")
                            ...
                            var e = t.classList.contains("dark")
                                ? "moon"
                                : "sun";
                    ...
                    document.querySelectorAll(".navbar").length &&
                        document
                            ...
                            .forEach(function (e, t) {
                                ...
                                o.includes(".html") || (o += "index.html"),
                                    e.href === o &&
                                        ((n = e).classList.add("active"),
                                        n.parentNode.parentNode.classList.add(
                                            "active"
                                        ),
                                        n.parentNode.parentNode.parentNode.parentNode.classList.add(
                                            "active"
                                        ),
                                        n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.classList.add(
                                            "active"
                                        ));
                            });
                },
